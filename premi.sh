...
clear;clear;clear
  ...
  # // Banner
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo -e "  Welcome To aburifatTunneling ${YELLOW}(${NC}${green} Stable Edition ${NC}${YELLOW})${NC}"
echo -e " This Will Quick Setup VPN Server On Your Server"
echo -e "  Auther : ${green}Lunatic® ${NC}${YELLOW}(${NC} ${green} LunaticTunnel${NC}${YELLOW})${NC}"
echo -e " © Recode By My aburifat Tunneling${YELLOW}(${NC} 2023 ${YELLOW})${NC}"
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo ""
sleep 2
###### IZIN SC 
...
Exp1=$(curl https://raw.githubusercontent.com/lamono45/Regist/main/afk | grep $MYIP | awk '{print $3}')
if [[ $today < $Exp1 ]]; then
sts="${Info}"
else
sts="${Error}"
...
wget raw.githubusercontent.com/lamono45/vip/main/limit/limit.sh && chmod +x limit.sh && ./limit.sh
